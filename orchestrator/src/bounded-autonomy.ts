...
export function decideNextAction(
  ...
  if (bookDone && hasPendingBookQualityFixes(workbench)) {

    if (effective.allowedMissionIds.includes("juno-book-quality-2026")) {
  ...
  if (bookDone && needsSelfOptimizeRun(workbench)) {
  ...
  if (bookDone) {
    ...
    return {
      ...
      reason: "axiom book complete — quality scan clean; await human next north-star",
  ...
  return {
    ...
    reason: "no_autonomous_work_remaining — await human north-star",
