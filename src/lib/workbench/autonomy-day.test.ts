...
import {
  autonomyDateAtMs,
  msUntilNextAutonomyDay,
  todayAutonomyDate,
} from "../../../orchestrator/src/autonomy-day.js";
...
describe("autonomy-day", () => {
  ...
  it("fails closed on an invalid timezone instead of switching to UTC", () => {
    expect(() => autonomyDateAtMs(Date.now(), "Not/A-Timezone")).toThrow();
  });
});
